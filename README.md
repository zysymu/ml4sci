...
- **Specific test (II):** Learning the DM representation: solution can be found [here](https://nbviewer.jupyter.org/github/zysymu/ml4sci/blob/main/domain_adaptation/domain_adaptation.ipynb)! **NOTE:** I had to submit the evaluation test until March 24 and this last link is my original submission. Since then I continued experimenting with AAEs and managed to get much better results and fix a lot of mistakes that I had made during my rush to finish the evaluation test on time. The new version can be seen in the `aae.ipynb` file, but I also created a new repository just for this file which can be accessed over [here](https://github.com/zysymu/unsupervised-adversarial-autoencoder)!
